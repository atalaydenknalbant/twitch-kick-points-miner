...
const (
	ProductName         = "Twitch Kick Points Miner"
	ProductTagline      = "Dual platform points and rewards miner"
	BuildLabel          = "Official build"
	PlatformTwitchToken = "{{TKPM_PLATFORM_TWITCH}}"
	PlatformKickToken   = "{{TKPM_PLATFORM_KICK}}"
	RepositoryURL       = "https://github.com/atalaydenknalbant/twitch-kick-points-miner"
	ReleasesAPIURL      = "https://api.github.com/repos/atalaydenknalbant/twitch-kick-points-miner/releases/latest"
